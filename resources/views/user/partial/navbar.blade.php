                ...
                <nav class="main__menu--navigation">
                    <ul class="main__menu--wrapper d-flex align-items-center">
                        <li class="main__menu--items">
                            <a class="main__menu--link" href="{{ route('home.pages','home')}}"><svg width="11" height="11" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li class="main__menu--items">
                            <a class="main__menu--link" href="./my-properties.html"> About </a>  
                        </li>
                        <li class="main__menu--items">
                        ...
                        <li class="main__menu--items">
                            <a class="main__menu--link" href="../blog.html">FAQs</a>
                        </li>
                        <li class="main__menu--items">
                            <a class="main__menu--link" href="../blog.html">Contact</a>
                        </li>
                    </ul>
                </nav>
            </div>
