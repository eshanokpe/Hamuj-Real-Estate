            ...
            <nav class="navbar-custom" id="navbar-custom">    
                <ul class="list-unstyled topbar-nav float-end mb-0">
                    <li class="dropdown">
                        ...
                        <img src="{{ asset('admin/images/flags/us_flag.jpg')}}" alt="" class="thumb-xxs rounded">
                    </a>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="#"><img src="{{ asset('admin/images/flags/us_flag.jpg')}}" alt="" height="15" class="me-2">English</a>
                            <a class="dropdown-item" href="#"><img src="{{ asset('admin/images/flags/spain_flag.jpg')}}" alt="" height="15" class="me-2">Spanish</a>
                            <a class="dropdown-item" href="#"><img src="{{ asset('admin/images/flags/germany_flag.jpg')}}" alt="" height="15" class="me-2">German</a>
                            <a class="dropdown-item" href="#"><img src="{{ asset('admin/images/flags/french_flag.jpg')}}" alt="" height="15" class="me-2">French</a>
                        </div>
                        ...
                        <div class="dropdown-menu dropdown-menu-end dropdown-lg pt-0">
                            ...
                            <div class="notification-menu" data-simplebar>
                                ...
                                <a href="#" class="dropdown-item py-3">
                                    ...
                                    <div class="media">
                                        <div class="avatar-md bg-soft-primary">
                                            <img src="{{ asset('admin/images/users/user-4.jpg')}}" alt="" class="thumb-sm rounded-circle">
                                        </div>
                                        <div class="media-body align-self-center ms-2 text-truncate">
                                ...
                                <a href="#" class="dropdown-item py-3">
                                    ...
                                    <div class="media">
                                        <div class="avatar-md bg-soft-primary">
                                            <img src="{{ asset('admin/images/users/user-2.jpg')}}" alt="" class="thumb-sm rounded-circle">
                                        </div>
                                        <div class="media-body align-self-center ms-2 text-truncate">
                                ...
                                <a href="#" class="dropdown-item py-3">
                                    ...
                                    <div class="media">
                                        <div class="avatar-md bg-soft-primary">
                                            <img src="{{ asset('admin/images/users/user-5.jpg')}}" alt="" class="thumb-sm rounded-circle">
                                        </div>
                                        <div class="media-body align-self-center ms-2 text-truncate">
                                            <h6 class="my-0 fw-normal text-dark">Your order is placed</h6>
                                            <small class="text-muted mb-0">It is a long established fact that a reader.</small>
                    ...
                    <li class="dropdown">
                        <a class="nav-link dropdown-toggle nav-user" data-bs-toggle="dropdown" href="#" role="button"
                            ...
                            <div class="d-flex align-items-center">
                                <img src="{{ asset('admin/images/users/user-4.jpg')}}" alt="profile-user" class="rounded-circle me-2 thumb-sm" />
                                <div>
