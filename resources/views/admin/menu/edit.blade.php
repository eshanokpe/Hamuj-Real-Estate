                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Menu Edit Form</h4>
                         </div><!--end card-header-->
                        <div class="card-body">
                            @if(session('success'))
                            ...
                            <form method="POST" action="{{ route('admin.menu.update', $menuItem->id) }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" value="{{ $menuItem->name }}" name="name" id="name" placeholder="Enter Menu Item Name" required>
                                 </div>
                                <div class="mb-3">
