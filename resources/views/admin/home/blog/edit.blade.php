                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('admin.post.update', $post->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea id="basic-conf" name="content">{{ $post->content }}</textarea>
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputEmail1">Image</label>
                                    <input onchange="previewImage(event)" class="form-control @error('image') is-invalid @enderror" type="file" value="" name="image" >
                                    @error('image')
