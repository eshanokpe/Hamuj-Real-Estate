            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Neighborhood</h4>
                    </div>
                    <!--end page-title-box-->
                </div>
                <!--end col-->
            ...
            <!-- end page title end breadcrumb -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 ">
                        ...
                        <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Add Neighborhood Details for {{ $property->name }} </h4>
                                </div>
                                <div class="card-body">
                                    <form method="POST" action="{{ route('admin.properties.neighborhood.store') }}" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col text-end">
                                                <label for="neighborhood_category_id" ></label>
                                                <div class="mb-3">
                                                    <a href="{{ route('admin.properties.neighborhood.category')}}" class="btn btn-primary">Add Category </a>
                                        ...
                                        <div class="row">
                                            <div class="mb-3">
                                                <label for="exampleInputEmail1">Enter Neighborhood Name</label>
                                                <input type="text" class="form-control" name="neighborhood_name" placeholder="Enter Neighborhood Name" required>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control"  step="0.01" name="distance" placeholder="Enter Distance" required>
                                                @error('neighborhood_name')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
