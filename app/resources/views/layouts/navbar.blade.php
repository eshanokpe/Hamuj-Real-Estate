<!--=== Start Header Area ===-->
<header class="header-area header-three fixed-top">
    <!--==== Header Navigation ===-->
                ...
                <div class="theme-nav-menu">
                    ...
                    <nav class="main-menu">
                        <ul>
                            ...
                            <li class="menu-item has-children">
                                <a href="{{ route('certifications.index') }}">Certifications & Training</a>
                                <ul class="sub-menu">
                                    <li><a href="{{ route('certifications.diploma.grc-financial-crime-prevention') }}"> Advanced Diploma in GRC & Financial Crime Prevention</a></li>
                                    <li><a href="{{ route('certifications.cybersecurity-finance') }}"> Cybersecurity & Data Security for Financial Institutions</a></li>
                                    <li><a href="{{ route('certifications.risk-analytics-monitoring') }}"> Monitoring, Reporting & Risk Analytics</a></li>
                                    <li><a href="{{ route('certifications.regulatory-compliance') }}"> Regulatory Compliance & Supervisory Engagement</a></li>
                                    <li><a href="{{ route('certifications.regtech-suptech') }}">RegTech, SupTech & Innovation in Compliance</a></li>
                                    <li><a href="{{ route('certifications.insurtech-fintech') }}"> InsurTech, FinTech & Emerging Market Compliance</a></li>
                                    <li><a href="{{ route('certifications.executive-masterclasses') }}"> Executive Masterclasses & Short Courses</a></li>
                                </ul>
                            </li> 
                            <li class="menu-item"><a href="{{ route('events.index') }}">Event</a></li>
                    ...
                    <div class="theme-nav-button mt-20 d-block d-md-none">
                        <a href="#" class="theme-btn style-one">Get Involved<i class="far fa-arrow-right"></i></a>
                    </div>
                    <!--=== Menu Bottom ===-->
                ...
                <div class="nav-right-item">
                    ...
                    @else
                        ...
                        <div class="user-profile-section d-flex align-items-center">
                            ...
                            <div class="cart-dropdown me-3" wire:ignore>
                                ...
                                <div class="dropdown-menu dropdown-menu-end profile-menu" aria-labelledby="profileDropdown">
                                    ...
                                    <div class="profile-header text-center p-3">
                                        <div class="profile-pic mb-2">
                                            ...
                                            @else
                                                <div class="avatar-placeholder rounded-circle d-flex align-items-center justify-content-center mx-auto" 
                                                    style="width: 60px; height: 60px; background-color: #293567; color: white; font-size: 24px;">
                                                    {{ strtoupper(substr(Auth::user()->name, 0, 1)) }}
                                                </div>
                                            @endif
                                        </div>
                                        ...
                                        <div class="profile-info">
                                            ...
                                            <span class="badge {{ Auth::user()->role === 'tutor' ? 'bg-warning' : 'bg-info' }} mt-2" 
                                    ...
                                    <a href="{{ route('learner.cart.index') }}" class="dropdown-item">
...
<!-- Add JavaScript for scroll effect and cart functionality -->
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Refresh cart when dropdown opens
