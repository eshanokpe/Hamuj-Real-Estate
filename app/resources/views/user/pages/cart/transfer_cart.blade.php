        ...
        <main class="main__content_wrapper">
            ...
            <div class="dashboard__container dashboard__reviews--container">
                <div class="cart__footer d-flex justify-content-between align-items-center mt-4">
                    ...
                    <div>
                        <a href="#" class="solid__btn" id="make-payment-btn" style="opacity: 0.6; cursor: not-allowed;" disabled>Continue</a>
                    </div>
                </div>
...
<script>
    ...
    function updateCart(row) {
        ...
        const safeCalculatedSize = Math.min(calculatedSize, initialAvailableSize);
        ...
        // Update available size display (remaining after this transfer)
        ...
        if (safeCalculatedSize !== calculatedSize && !exceedsAvailableSize) {
    ...
    document.querySelectorAll('.cart__table tbody tr').forEach(row => {
        ...
        amountInput.addEventListener('change', () => {
            ...
            if (calculatedSize > initialAvailableSize) {
                ...
                alert(`The amount entered would exceed your available land size. Maximum amount you can transfer: ₦${maxAmount.toLocaleString('en-NG', { minimumFractionDigits: 2 })}`);
                amountInput.value = '';
            }
    ...
    document.getElementById('make-payment-btn').addEventListener('click', function(event) {
        ...
        if (amount === '' || parseFloat(amount) < 1000) {
            alert('Please enter an amount of at least ₦1,000 to transfer.');
            return;
        }
