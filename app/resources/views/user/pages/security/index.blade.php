                                ...
                                <div class="sales__report--section p-4" >
                                    <div class="accordion accordion-flush">
                                        ...
                                        <div class="accordion-item mb-3">
                                            <div class="d-flex"> 
                                                <div class="p-2 w-100 d-flex align-self-center">
                                                    <img src="{{ asset('assets/admin/img/dashboard/identity.png')}}" alt="Identity Verification" 
                                                        class="me-2" style="width:50px; height:50px; max-width:100px; max-height:100px; object-fit:contain">
                                                    <h1 class="dashboard__chart--title align-self-center">Identity Verification</h1>
                                                </div>
                                                <a href="{{ route('user.identity.verification') }}"> 
                                                    <div class="p-2 flex-shrink-1">
                                                        <img src="{{ asset('assets/admin/img/dashboard/right_arrow.jpg')}}" alt="Verify" 
                                                            class="me-2" style="width:50px; height:50px; max-width:100px; max-height:100px; object-fit:contain">
                                                    </div> 
                                                </a>
                                            </div>
