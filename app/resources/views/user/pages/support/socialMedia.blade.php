                            ...
                            <div class="col-lg-12">
                                <div class="swiper-slide">
                                    <div class="currency__card">
                                        ...
                                        <p>You can follow us on our following social networks</p>
                                   
                                        <div class="d-flex p-2">
                                            <div class="flex-shrink-0 align-self-center">
                                                <a href="{{ $sociallink->facebook }}">
                                                <img src="{{ asset('assets/admin/img/dashboard/facebook.png')}}" alt="Buy" class="me-2" width="30">
                                                </a>
                                            </div>
                                            <div class="flex-grow-1 ms-3 align-self-center">
                                                <a href="{{ $sociallink->facebook }}">
                                                    <b> {{ $sociallink->facebook }}</b> 
                                                </a>
                                            </div>
                                        </div>
                                        <hr/>
                                        <div class="d-flex p-2">
                                            <div class="flex-shrink-0 align-self-center">
                                                ...
                                                <img src="{{ asset('assets/admin/img/dashboard/twitter.png')}}" alt="Buy" class="me-2" width="30">
                                                </a>
                                            </div>
                                            <div class="flex-grow-1 ms-3 align-self-center">
                                                <a href="{{ $sociallink->twitter }}">
                                                    <b> {{ $sociallink->twitter }}</b> 
                                                </a>
                                            </div>
                                        </div>
                                        <hr/>
                                        <div class="d-flex p-2">
                                            <div class="flex-shrink-0 align-self-center">
                                                ...
                                                <img src="{{ asset('assets/admin/img/dashboard/linkedin.png')}}" alt="Buy" class="me-2" width="30">
                                                </a>
                                            </div>
                                            <div class="flex-grow-1 ms-3 align-self-center">
                                                <a href="{{ $sociallink->linkedin }}">
                                                    <b> {{ $sociallink->linkedin }}</b> 
                                                </a>
                                            </div>
                                        </div>
                                        <hr/>
                                        <div class="d-flex p-2">
                                            <div class="flex-shrink-0 align-self-center">
                                                ...
                                                <img src="{{ asset('assets/admin/img/dashboard/whatsapp.png')}}" alt="Buy" class="me-2" width="30">
                                                </a>
                                            </div>
                                            <div class="flex-grow-1 ms-3 align-self-center">
                                                <a href="{{ $sociallink->whatsapp }}">
                                                    <b> {{ $sociallink->whatsapp }}</b> 
                                                </a>
                                            </div>
                                        </div>
                                        <hr/>
                                        <div class="d-flex p-2">
                                            <div class="flex-shrink-0 align-self-center">
                                                ...
                                                <img src="{{ asset('assets/admin/img/dashboard/youtube.png')}}" alt="Buy" class="me-2" width="30">
                                                </a>
                                            </div>
                                            <div class="flex-grow-1 ms-3 align-self-center">
                                                <a href="{{ $sociallink->youtube }}">
                                                    <b> {{ $sociallink->youtube }}</b> 
                                                </a>
                                            </div>
                                        </div>
