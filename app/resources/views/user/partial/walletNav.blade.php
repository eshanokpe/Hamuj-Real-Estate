<div class="header__user--profile d-flex">
    <!-- Hide Balance Toggle -->
    <a href="#" class="main__menu--link d-flex align-items-center justify-content-between" style="gap: 5px;">
    ...
    <div class="wallet-dropdown-container position-relative">
        <button class="wallet-balance-display d-flex align-items-center bg-transparent border-0 p-0"
            ...
            <span id="walletBalanceText" class="me-1" style="font-size: 12px; padding-top:10px">
                ...
                @else
                    ...
                    @endphp
                    <span class="currency" style="font-size: 12px;">{{ $currency }}</span>
                    <span class="amount" style="font-size: 12px">{{ $formattedBalance }}</span>
                @endif
            </span>
    ...
    <ul class="nav-bar__menu d-flex p-2" style="margin-right: 10px">
