...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/sell/history', [SellPropertyController::class, 'sellPropertyHistory']);
    ...
    //Referral
    Route::get('referral/data', [ReferralController::class, 'index']); 
    ...
    Route::get('/virtual-account', [DashboardController::class, 'virtualAccount']);
    ...
    Route::prefix('add_properties')->group(function () {
        Route::get('property/type', [AddPropertyController::class, 'propertyType']); 
