...
Route::middleware('auth')->prefix('user')->name('user.')->group(function () {
    ...
    Route::post('/transfer/recipient/initiate', [TransferPropertyController::class, 'submitTransferRequest'])->name('submit.transferRequest');
    
    Route::match(['get', 'post'], '/transfer/verify/recipient', [TransferPropertyController::class, 'verifyRecipient'])->name('transfer.checkRecipient');
